...
if __name__ == '__main__':
    class TabEngine:
        ...
        @classmethod
        def to_query(cls,engine_name, **kwargs):
        ...
        # def to_query(self):
        #     full_query = f'{self.order_by()} {self.partition_by()} {self.sample_by()} {self.settings()} {self.TTL()}'
        #     return full_query
    ...
    test = TabEngine(engine_name='MergeTree', partition_columns='sadf',
