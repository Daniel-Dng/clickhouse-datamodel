...
class Columns(Tables):
    def __init__(self, col_name, data_type, nullable=0, function=''):
...
# test = Columns('ps_name', 'String', 1).add_function('LowCardinality').add_codec('Default')
...
# tab = Tables('payment_systems', 'entities', 'MergeTree')#.add_columns('   ps_ndames',' asd')
